...
color2= "#254159"
#color2= "scarlet"
whitened_data = "_data/gw_images/whitened_GW150914_Hanford.csv"
template_data = "_data/gw_images/template_GW150914_Hanford_"
image_file = "assets/waveform_plot_GW150914_inv_colors.png"
...
datafile = '_data/gw_images/output_GW150914.hdf5'
psdfile = '_data/gw_images/GWTC1_GW150914_PSDs.dat.txt'
...
fig= gmcmc.plot_bayesogram(datafile, psdfile, "Hanford",generation_method_base='IMRPhenomD',generation_method_extended=None, threads=10, xlim = [5.8,6.1],data_stream_file=datastreamfile,figsize=[30,6],gpstime=gpstime,color='crimson')
